...
set DISK_FORMAT_FILE=%DELETE_VDISK_FILE%
::
...
set DISKPART_CMD_GENERATOR=%~dp0\..\..\..\DriveFormat\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%~dp0\..\..\..\DriveFormat\Subroutine\diskpartVerify.cmd