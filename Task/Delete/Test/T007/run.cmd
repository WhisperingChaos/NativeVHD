...
setlocal
  ...
  echo TRANSACTION_GUID={12893128-123123-4-123-42132}| call "%METHOD_PATH%\Create.cmd" "%~dp0\config.cmd"
  if %errorlevel% neq 0 exit /b %errorlevel%
...
:TestValidation:
  ...
  type "%TASK_CREATE_SHARED_REQUEST_DIR%\%TASK_CREATE_NAME%"  | find "TRANSACTION_GUID={12893128-123123-4-123-42132}" >nul
  if %errorlevel% neq 0 (
  	echo Abort: Expecting an environment variable assignment statement.>&2
	exit /b 1
  )
exit /b 0