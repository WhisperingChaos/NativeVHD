...
set MERGE_LAYER_FILE=%MERGE_LAYER_FILE%
::
::-- Required: The absolute path, enclosed in double quotes, to the immediate parent of the VHD layer.
set MERGE_CANONICAL_BASE_FILE=%MERGE_CANONICAL_BASE_FILE%
::