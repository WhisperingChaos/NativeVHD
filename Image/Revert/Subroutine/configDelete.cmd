...
set DISKPART_CMD_GENERATOR=%VDISK_METHODS%\Delete\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%VDISK_METHODS%\Delete\Subroutine\diskpartverify.cmd
::
