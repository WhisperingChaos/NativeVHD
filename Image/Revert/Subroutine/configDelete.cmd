...
set DISKPART_CMD_GENERATOR=%BIND_VDISK%\Delete\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%BIND_VDISK%\Delete\Subroutine\diskpartverify.cmd
::
