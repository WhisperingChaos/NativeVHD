...
set DELETE_VHD_FILE=%TEST_VHD_FILE%
::
...
set DISKPART_CMD_GENERATOR=%~dp0\..\..\..\..\Image\Delete\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%~dp0\..\..\..\..\Image\Delete\Subroutine\diskpartVerify.cmd
::
exit /b 0 
