...
set DELETE_VHD_FILE=%DELETE_VHD_FILE%
::
...
set DISKPART_CMD_GENERATOR=%VDISK_METHOD_PATH%\Delete\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%VDISK_METHOD_PATH%\Delete\Subroutine\diskpartVerify.cmd
::
exit /b 0 
