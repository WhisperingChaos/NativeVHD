...
set DISKPART_CMD_GENERATOR=%VDISK_METHOD_PATH%\LayerCreate\Subroutine\diskpartCmdGen.cmd
::
...
set DISKPART_CONSTRAINT_CHECK=%VDISK_METHOD_PATH%\LayerCreate\Subroutine\diskpartVerify.cmd